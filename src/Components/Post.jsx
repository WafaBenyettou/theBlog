...
function Post({ posts }) {
  ...
  return (
    <div>
      {firstPost && (
        // Add the "post-container" class here
        <div className='grid grid-cols-1 cursor-pointer md:grid-cols-2 mt-10 px-10 md:px-15 lg:px-32 gap-8 post-container' key={firstPost.id} onClick={() => navigate('blog/' + firstPost.id)}>
